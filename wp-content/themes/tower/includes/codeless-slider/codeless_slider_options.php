    ...
    function cl_add_codeless_slider_metaboxes($metaboxes) {
        ...
        $slide_content = array(
            ...
            'fields'        => array(
                ...
                array(
                    'id' => 'slide_subtitle_switch',
                    'type' => 'switch',
                    'title' => __('Add SubTitle before the main title', 'codeless-admin'),
                    'subtitle' => __('', 'codeless-admin'),
                    "default" => 0
                ),
                ...
                array(
                    'id' => 'slide_subtitle',
                    'type' => 'textarea',
                    'title' => __('SubTitle', 'codeless-admin'),
                    'required' => array('slide_subtitle_switch', 'equals', 1),
                ),

                array(
                    'id'          => 'slide_subtitle_style',
                    'type'        => 'typography', 
                    'title'       => __('SubTitle Style', 'codeless-admin'),
                    'google'      => true, 
                    'font-backup' => false,
                    'font-style'  => false,
                    'text-transform' => true,
        ...
        $slide_layout = array(
            ...
            'fields'        => array(
                 ...
                 array(
                    ...
                    'desc'           => __('In case you select vertical centered, top and bottom positions are fixed. The same for horizontal centered, left and right are fixed. Them are not considerated. If you want to use only absolute positions (Left, Right, Top, Bottom) select "Use only absolute position" ', 'codeless'),
                    'default'            => array(
                        'top'    => '',
                        'bottom' => '',
                        'left'   => '',
