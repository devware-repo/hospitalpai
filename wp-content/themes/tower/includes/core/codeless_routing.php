...
if(!function_exists('codeless_routing_template'))
{
	...
	function codeless_routing_template( $current_template = false )
	{
		...
		/* For Online */
		if(isset($post) && $post->ID == 865){
			$cl_redata['bloglayout'] = 'sidebar_left';
			$cl_redata['blog_style'] = 'normal';
			$codeless_config['new_query'] = array( 	'paged' => get_query_var( 'paged' ), 
												    'posts_per_page' => get_option('posts_per_page'));	
			$for_online = true;									
			get_template_part( 'template', 'blog' ); exit();
		}	
		if(isset($post) && $post->ID == 868){
			$cl_redata['bloglayout'] = 'fullwidth';
			$cl_redata['blog_style'] = 'normal';
			$codeless_config['new_query'] = array( 	'paged' => get_query_var( 'paged' ), 
												    'posts_per_page' => get_option('posts_per_page'));	
			$for_online = true;									
		...
		if(isset($post) && $post->ID == 880){
			$cl_redata['bloglayout'] = 'sidebar_right';
			$cl_redata['blog_style'] = 'alternate';
			$codeless_config['new_query'] = array( 	'paged' => get_query_var( 'paged' ), 
												    'posts_per_page' => get_option('posts_per_page'));	
			$for_online = true;									
			get_template_part( 'template', 'blog' ); exit();
		}
		if(isset($post) && $post->ID == 882){
			$cl_redata['bloglayout'] = 'sidebar_left';
			$cl_redata['blog_style'] = 'alternate';
			$codeless_config['new_query'] = array( 	'paged' => get_query_var( 'paged' ), 
												    'posts_per_page' => get_option('posts_per_page'));	
		...
		if(isset($post) && $post->ID == 890){
			$cl_redata['bloglayout'] = 'sidebar_right';
			$cl_redata['blog_style'] = 'creative';
			$codeless_config['new_query'] = array( 	'paged' => get_query_var( 'paged' ), 
												    'posts_per_page' => get_option('posts_per_page'));	
			$for_online = true;									
			get_template_part( 'template', 'blog' ); exit();
		}
		if(isset($post) && $post->ID == 893){
			$cl_redata['bloglayout'] = 'sidebar_left';
			$cl_redata['blog_style'] = 'creative';
			$codeless_config['new_query'] = array( 	'paged' => get_query_var( 'paged' ), 
												    'posts_per_page' => get_option('posts_per_page'));	
		...
		if(isset($post) && $post->ID == 901){
			$cl_redata['bloglayout'] = 'sidebar_right';
			$cl_redata['blog_style'] = 'timeline';
			$codeless_config['new_query'] = array( 	'paged' => get_query_var( 'paged' ), 
												    'posts_per_page' => get_option('posts_per_page'));
			$for_online = true;										
			get_template_part( 'template', 'blog' ); exit();
		}
		if(isset($post) && $post->ID == 903){
			$cl_redata['bloglayout'] = 'sidebar_left';
			$cl_redata['blog_style'] = 'timeline';
			$codeless_config['new_query'] = array( 	'paged' => get_query_var( 'paged' ), 
												    'posts_per_page' => get_option('posts_per_page'));
		...
		if(isset($post) && $post->ID == 911){
			$cl_redata['bloglayout'] = 'fullwidth';
			$cl_redata['blog_style'] = 'grid';
			$cl_redata['blog_grid_col'] = 3;
			$codeless_config['new_query'] = array( 	'paged' => get_query_var( 'paged' ), 
												    'posts_per_page' => get_option('posts_per_page'));
			$for_online = true;										
			get_template_part( 'template', 'blog' ); exit();
		}	
		if(isset($post) && $post->ID == 915){
			$cl_redata['bloglayout'] = 'sidebar_left';
			$cl_redata['blog_style'] = 'grid';
			$cl_redata['blog_grid_col'] = 2;
			$codeless_config['new_query'] = array( 	'paged' => get_query_var( 'paged' ), 
												    'posts_per_page' => get_option('posts_per_page'));
			$for_online = true;										
			get_template_part( 'template', 'blog' ); exit();
		}		
		if(isset($post) && $post->ID == 917){
			$cl_redata['bloglayout'] = 'sidebar_right';
			$cl_redata['blog_style'] = 'grid';
			$cl_redata['blog_grid_col'] = 2;
			$codeless_config['new_query'] = array( 	'paged' => get_query_var( 'paged' ), 
