...
if (class_exists('WPBakeryVisualComposerAbstract')) {
	...
	function vc_iconselect_css_register() {    
	    ...
	    wp_register_style( 'font-awesome1',CODELESS_BASE_URL.'css/font-awesome.min.css' );
	    ...
	    wp_register_style( 'modify_js_composer',CODELESS_BASE_URL.'css/modify_js_composer.css' );
	}
	...
	function vc_iconselect_css_load() {
		...
		{	
	    	...
	    	wp_enqueue_style('modify_js_composer');
