...
var scnDialogHelper = {
    ...
    loadShortcodeDetails: function () {
        ...
        if (scnSelectedShortcodeType) {
            var a = this;
            jQuery.getScript(codeless_global.frameworkUrl + "includes/core/shortcodes/sc/" + scnSelectedShortcodeType + ".js", function () {
                a.initializeDialog()
            })
        }
    },
    ...
    getTableKeyValue: function (a) {
    	...
    	var table_data = a.parents('#TB_window:eq(0)').find('#top .codeless_table');
    ...
    previewAction: function (a) {
        ...
        jQuery("#scn-preview-iframe").attr("src", codeless_global.frameworkUrl + "includes/core/shortcodes/preview-shortcode-external.php?shortcode=" + encodeURIComponent(this.makeShortcode()))
    },
