    ...
    function cl_add_single_portfolio_metaboxes($metaboxes) {
        ...
        $page_style = array(
            ...
            'fields'        => array(
                ...
                array(
                    'id' => 'use_as_text_block',
                    'type' => 'switch',
                    'title' => __('Use this item as text block in masonry element style', 'codeless-admin'),
                    'default' => 0// 1 = on | 0 = off
                ),
        ...
        $page_header_section = array(
            ...
            'fields' => array(  
                            ...
                            array(
                                ...
                                'options' => array('normal' => 'Basic (Title & Subtitle in Left)', 'centered' => 'Centered'), //Must provide key => value pairs for select options
                            ...
                            array(
                                ...
                                'default' =>  $cl_redata['page_header_breadcrumbs'],
                                'required' => array('page_header_overwrite','=','1') 
                            ),
        ...
        $slider_section = array(
            ...
            'fields' => array(
                            ...
                            array(
                                'id'=>'slider_ontop',
                                'type' => 'switch', 
                                'title' => __('Slider On Top of the Page', 'codeless-admin'),
                                'subtitle'=> __('Add Slider on top of the page and show menu directly after slider. Cant use with transparent header', 'codeless-admin'),
                                "default"       => 0,
                            ), 

                            array(
                                'id' => 'slider_pagination_style',
                                'type' => 'select',
                                'title' => __('Select Slider Pagination', 'codeless-admin'),
                                'subtitle' => __('', 'codeless-admin'),
                                'options' => array('thumbflip'=>'ThumbFlip', 'roundslide' => 'RoundSlide'), //Must provide key => value pairs for select options
                                'default' =>  'roundslide',
                                'required' => array('slider_type', '=', 'codeless')
                            ),
        ...
        $page_opt_style = array(
            ...
            'fields' => array(
                            ...
                            array(
                                ...
                                'type' => 'select',
                                'title' => __('Header Color Style for Header', 'codeless-admin'),
