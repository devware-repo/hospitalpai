...
if(have_posts()){
    ...
    $masonry_order[4] = array('w2', 'w1', 'w1', 'w2h2', 'w1h2', 'w2h2', 'w1h2', 'w1', 'w1', 'w1', 'w1', 'w2h2', 'w1', 'w1', 'w1', 'w1');
    ...
    while (have_posts()) : the_post();  
        ...
        if($masonry_order[$columns][$loop_counter%15] == 'w2h2')
            $port_size = 'port3_2';

        if($masonry_order[$columns][$loop_counter%15] == 'w1h2')
            $port_size = 'port3_3';
    ...
    <!-- item -->
                    <?php if(!$cl_redata['use_as_text_block']): ?>
                            <div class="portfolio-item mix <?php echo esc_attr($masonry_order[$columns][$loop_counter%15]); ?> <?php echo esc_attr($sort_classes) ?> <?php echo esc_attr($extra_class) ?> <?php echo $style ?>" data-id="<?php echo get_the_ID() ?>">
                                        <div class="he-wrap tpl2">
                                        <a href="<?php echo $link ?>"></a>
                                        <img src="<?php echo esc_url(codeless_image_by_id(get_post_thumbnail_id(), $port_size, 'url')) ?>" alt="">
                    ...
                    <?php if($cl_redata['use_as_text_block']): ?>
                        <div class="portfolio-item mix portfolio_text_block <?php echo esc_attr($masonry_order[$columns][$loop_counter%15]); ?> <?php echo esc_attr($sort_classes) ?> <?php echo esc_attr($extra_class) ?> <?php echo $style ?>" data-id="">
                            <div class="wrap">
                                    <a href="<?php echo $link ?>"></a>
                                    <img src="<?php echo esc_url(codeless_image_by_id(get_post_thumbnail_id(), $port_size, 'url')) ?>" alt="">
                                   
                                    <div class="overlay">
                                        <div class="bg"><div class="content">
                                            <?php the_content(); ?>
                                        </div></div>    
                                    </div>   
                            </div>                   
