                        ...
                        <div class="overlay he-view">
                            <div class="bg a0" data-animate="fadeIn">
                                <div class="center-bar v1">
                                    ...
                                    <a href="<?php echo $link ?>" class="link a1" data-animate="fadeInRight"><i class="moon-link-4"></i></a></a>
                                </div>
                             </div> 
                        </div>                          
                    </div>   
            ...
            <?php }else if($style == 'chrome'){ ?>
                ...
                <div class="portfolio-item mix <?php echo esc_attr($sort_classes) ?> <?php echo esc_attr($extra_class) ?>  <?php echo esc_attr($style) ?>" data-id="<?php echo get_the_ID() ?>">
                    <div class="overlay">
                        ...
                        <span>
                            <a href="<?php echo esc_url($link) ?>" class="btn-bt <?php echo $cl_redata['overall_button_style'][0] ?>"><?php _e('View', 'codeless') ?></a>
                        </span>
                    </div>
