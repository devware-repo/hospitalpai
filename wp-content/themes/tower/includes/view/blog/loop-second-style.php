...
if (have_posts()) :
    ...
    while (have_posts()) : the_post();
        ...
        $attach_size = 'alternate_blog';
        if($cl_redata['bloglayout'] != 'fullwidth')
            $attach_size = 'alternate_blog_side';
         ...
         ?>
                ...
                <div class="media">
                    ...
                    <?php if($post_format == 'audio'){
                        ...
                        echo do_shortcode('[soundcloud]'.$cl_redata['media_post_link'].'[/soundcloud]');
                        ...
                        <img src="<?php echo esc_url(codeless_image_by_id(get_post_thumbnail_id(), $attach_size, 'url')) ?>" alt="">
