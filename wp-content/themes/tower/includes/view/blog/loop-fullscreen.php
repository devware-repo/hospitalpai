...
if (have_posts()) :
 ...
 <article id="post-<?php echo the_ID(); ?>" <?php echo post_class('fullscreen-blog-article section'); ?> style="background-image:url('<?php echo esc_url(codeless_image_by_id(get_post_thumbnail_id(), '', 'url')) ?>');">                    
            ...
            <div class="content <?php echo esc_attr($cl_redata['fullscreen_post_position']) ?> with_animation animated <?php echo esc_attr($font_color) ?>" data-animation="<?php echo esc_attr($cl_redata['fullscreen_post_effect']) ?>" data-delay="<?php echo esc_attr($cl_redata['fullscreen_post_delay']) ?>">        
