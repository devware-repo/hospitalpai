...
<div class="cart">
		...
		<a class="cart_icon cart_icon_active" href="<?php echo esc_url(get_permalink(get_option('woocommerce_cart_page_id'))); ?>"><i class="moon-cart-4"></i><span class="nr"><?php echo $woocommerce->cart->cart_contents_count ?></span></a>
