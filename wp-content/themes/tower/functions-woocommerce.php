...
function codeless_woocommerce_header_add_to_cart_fragment( $fragments ) {
    ...
    <div class="cart">
        ...
        <a class="cart_icon" href="<?php echo get_permalink(get_option('woocommerce_cart_page_id')); ?>"><i class="moon-cart-4"></i><span class="nr"><?php echo $woocommerce->cart->cart_contents_count ?></span></a>
        ...
        <a class="cart_icon cart_icon_active" href="<?php echo get_permalink(get_option('woocommerce_cart_page_id')); ?>"><i class="moon-cart-4"></i><span class="nr"><?php echo $woocommerce->cart->cart_contents_count ?></span></a> 
