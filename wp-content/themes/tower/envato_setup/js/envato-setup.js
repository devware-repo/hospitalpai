    ...
    function ContentManager(){
        ...
        function process_current(){
            if(current_item){
                ...
                var demo_content = jQuery('#demo').val();
                if(jQuery('#default_content_attachments').is(':checked')){
...
jQuery(document).ready(function(e) {
      ...
      jQuery('.demo_screenshot').on('click', function(e){

         
            jQuery('.demo_screenshot').removeClass('selected');

            jQuery(this).addClass('selected');

            var selected_demo = jQuery('.demo_screenshot.selected').data('content');

            jQuery('#demo').val(selected_demo);
