...
if ($cmsmasters_option['medical-clinic' . '_sitemap_nav']) { 
	echo '<h1>' . esc_html__('Website Pages', 'medical-clinic') . '</h1>';
...
if ($cmsmasters_option['medical-clinic' . '_sitemap_categs']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Blog Archives by Categories', 'medical-clinic') . '</h1>' . 
...
if ($cmsmasters_option['medical-clinic' . '_sitemap_tags']) {
	$tags = get_tags(array( 
		'orderby' => 'name', 
		'order' => 'DESC' 
	));
	...
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Blog Archives by Tags', 'medical-clinic') . '</h1>' . 
...
if ($cmsmasters_option['medical-clinic' . '_sitemap_month']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Blog Archives by Month', 'medical-clinic') . '</h1>' . 
	'<ul class="cmsmasters_sitemap_archive">';
...
if ($cmsmasters_option['medical-clinic' . '_sitemap_pj_categs']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Portfolio Archives by Categories', 'medical-clinic') . '</h1>' . 
	'<ul class="cmsmasters_sitemap_category">';
...
if ($cmsmasters_option['medical-clinic' . '_sitemap_pj_tags']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h1>' . esc_html__('Portfolio Archives by Tags', 'medical-clinic') . '</h1>' . 
	'<ul class="cmsmasters_sitemap_archive">';
