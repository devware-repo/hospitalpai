...
if (!function_exists('medical_clinic_get_custom_project_meta_fields')) {
function medical_clinic_get_custom_project_meta_fields() {
	...
	$cmsmasters_global_portfolio_project_title = (isset($cmsmasters_option['medical-clinic' . '_portfolio_project_title']) && $cmsmasters_option['medical-clinic' . '_portfolio_project_title'] !== '') ? (($cmsmasters_option['medical-clinic' . '_portfolio_project_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_project_details_title = (isset($cmsmasters_option['medical-clinic' . '_portfolio_project_details_title']) && $cmsmasters_option['medical-clinic' . '_portfolio_project_details_title'] !== '') ? $cmsmasters_option['medical-clinic' . '_portfolio_project_details_title'] : '';
	
	$cmsmasters_global_portfolio_project_share_box = (isset($cmsmasters_option['medical-clinic' . '_portfolio_project_share_box']) && $cmsmasters_option['medical-clinic' . '_portfolio_project_share_box'] !== '') ? (($cmsmasters_option['medical-clinic' . '_portfolio_project_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_project_author_box = (isset($cmsmasters_option['medical-clinic' . '_portfolio_project_author_box']) && $cmsmasters_option['medical-clinic' . '_portfolio_project_author_box'] !== '') ? (($cmsmasters_option['medical-clinic' . '_portfolio_project_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_more_projects_box = (isset($cmsmasters_option['medical-clinic' . '_portfolio_more_projects_box'])) ? $cmsmasters_option['medical-clinic' . '_portfolio_more_projects_box'] : 'related';
	
	$cmsmasters_proportion = medical_clinic_project_puzzle_proportion();
	...
	$tabs_array['cmsmasters_project'] = array( 
		'label' => esc_html__('Project', 'medical-clinic'), 
	...
	$custom_project_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Project Images', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Project', 'medical-clinic'), 
		...
		array( 
			'label'	=> esc_html__('Number of Columns', 'medical-clinic'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'three' => array( 
					'label' => esc_html__('Three', 'medical-clinic'), 
					'value'	=> 'three' 
				), 
				'two' => array( 
					'label' => esc_html__('Two', 'medical-clinic'), 
					'value'	=> 'two' 
				), 
				'one' => array( 
					'label' => esc_html__('One', 'medical-clinic'), 
					'value'	=> 'one' 
				) 
			) 
		),
		...
		array( 
			'label'	=> esc_html__('Project Title', 'medical-clinic'), 
		...
		array( 
			'label'	=> esc_html__('Project Size', 'medical-clinic'), 
			'desc'	=> esc_html__('Recommended Featured Image dimensions, or other size, with the same ratio', 'medical-clinic') . ' - ', 
		...
		array( 
			'label'	=> esc_html__('Project Details Title', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Info', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__("Project Link Text", 'medical-clinic'), 
			'desc'	=> '', 
			'id'	=> $cmsmasters_option_name . 'link_text', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('View Project', 'medical-clinic') 
		), 
		array( 
			'label'	=> esc_html__("Project Link URL", 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> '', 
			'desc'	=> esc_html__('Redirect to project link URL instead of opening project page', 'medical-clinic'), 
		...
		array( 
			'label'	=> esc_html__("Project Link Target", 'medical-clinic'), 
			'desc'	=> esc_html__('Open link in a new tab', 'medical-clinic'), 
		...
		array( 
			'label'	=> esc_html__('Project Features 1 Title', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 1', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2 Title', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3 Title', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3', 'medical-clinic'), 
			'desc'	=> '', 
