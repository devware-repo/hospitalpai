...
function medical_clinic_get_admin_page() {
	global $pagenow;
...
function medical_clinic_default_tab() {
	$current_page = medical_clinic_get_admin_page();
...
function medical_clinic_get_the_tab() {
	global $pagenow;
	
	$default_tab = medical_clinic_default_tab();
...
function medical_clinic_settings_page_header() {
