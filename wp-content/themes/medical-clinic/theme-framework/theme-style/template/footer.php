...
?>
<div class="footer <?php echo 'cmsmasters_color_scheme_' . $cmsmasters_option['medical-clinic' . '_footer_scheme'] . ($cmsmasters_option['medical-clinic' . '_footer_type'] == 'default' ? ' cmsmasters_footer_default' : ' cmsmasters_footer_small'); ?>">
	<div class="footer_inner">
		...
		?>
		<span class="footer_copyright copyright"><?php echo esc_html(stripslashes($cmsmasters_option['medical-clinic' . '_footer_copyright'])); ?></span>
	</div>
</div>