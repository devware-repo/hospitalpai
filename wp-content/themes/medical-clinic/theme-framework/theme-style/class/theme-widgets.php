			...
			if ($tweets != '') {
				...
				echo '<div class="cmsmasters_notice cmsmasters_notice_error cmsmasters_theme_icon_cancel">' . "\n" . 
					'<div class="notice_content">' . "\n" . 
						'<p>' . esc_html__('Please add your Twitter API keys', 'medical-clinic') . ', ' . '<a target="_blank" href="http://docs.cmsmasters.net/admin2/twitter-functionality/">' . esc_html__('read more how', 'medical-clinic') . '</a></p>' . "\n" . 
					'</div>' . "\n" . 
				'</div>' . "\n";
			}
		}
...
class WP_Widget_Custom_Colored_Text extends WP_Widget {
    ...
    function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id('bg_color'); ?>"><?php esc_html_e('Background Color', 'medical-clinic'); ?>:<br />
                <input class="my-color-field" id="<?php echo $this->get_field_id('bg_color'); ?>" name="<?php echo $this->get_field_name('bg_color'); ?>" type="text" value="<?php echo $bg_color; ?>" data-default-color="#56cce1" />
            </label>
        </p>
		<script type="text/javascript">
			jQuery(function($) {
				if ( 
					$('#<?php echo $this->get_field_id('bg_color'); ?>').is(':visible') || 
					$('#<?php echo $this->get_field_id('bg_color'); ?>').closest('.widget').is(':not(.ui-draggable)') 
				) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Title', 'medical-clinic'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
            </label>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('text'); ?>"><?php esc_html_e('Text', 'medical-clinic'); ?>:<br />
                <textarea class="widefat" id="<?php echo $this->get_field_id('text'); ?>" name="<?php echo $this->get_field_name('text'); ?>" rows="10" cols="20"><?php echo $text; ?></textarea>
            </label>
        </p>
        <?php
    }
...
function medical_clinic_theme_wp_custom_widgets_init() {
	...
	register_widget('WP_Widget_Custom_Colored_Text');
}

add_action('widgets_init', 'medical_clinic_theme_wp_custom_widgets_init', 1);
