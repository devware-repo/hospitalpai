...
function medical_clinic_single_project_layout($cmsmasters_layout) {
	if (
		is_singular('project') || 
		is_singular('profile') 
	) {
...
add_filter('cmsmasters_theme_page_layout_filter', 'medical_clinic_single_project_layout');



/* Search Form */
function medical_clinic_search_form($form) {
	$form = "<div class=\"search_bar_wrap\">
		<form method=\"get\" action=\"" . esc_url(home_url('/')) . "\">
			<p class=\"search_field\">
				<input name=\"s\" placeholder=\"" . esc_attr__('Buscar...', 'medical-clinic') . "\" value=\"\" type=\"search\" />
			</p>
...
add_filter('get_search_form', 'medical_clinic_search_form');
